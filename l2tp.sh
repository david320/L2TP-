...
#                                                                       #
#   CentOS 7+多IP VPS先删除firewalld，安装iptables先不启用并关闭selinux   #
#=======================================================================#
cur_dir=`pwd`
...
preinstall_l2tp(){
    ...
    read -p "(Default Range: 192.168.19):" iprange
    [ -z ${iprange} ] && iprange="192.168.19"

    echo "Please enter PSK:"
    read -p "(Default PSK: david):" mypsk
    [ -z ${mypsk} ] && mypsk="david"

    echo "Please enter Username:"
    read -p "(Default Username: lo):" username
    [ -z ${username} ] && username="lo"
